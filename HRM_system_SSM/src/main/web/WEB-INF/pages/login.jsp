...
<div class="container-fluid">
    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            <li><a href="go_login">登录</a></li>
            <li><a href="go_register">注册</a></li>
        </ol>
    </div>
</div>
<!--
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">公司简介<span class="sr-only">(current)</span></a></li>
                    <li><a href="#">追求卓越</a></li>
                    <li><a href="#">追求卓越</a></li>
                    <li><a href="#">追求卓越</a></li>
                </ul>
...
<div class="container" style="width:100%;height:460px;background:#FF2C4C url('../../img/background.jpg') no-repeat;">
    <div class="row">
        <div class="col-md-7">
