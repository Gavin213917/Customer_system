...
<table class="table table-hover" border="1px" width="1000px" height="100px" align="center" cellpadding="0px"
       cellspacing="0px">
    <c:forEach items="${sessionScope.positionList}" var="position" varStatus="a">
        <c:if test="${a.count==1}">
            <tr>
                <td>编号</td>
                <td>职位</td>
        ...
        <tr>
            ...
            <td>${position.dep_id}</td>
            <td>
                <form action="delete_position" method="post">
                    <input type="hidden" name="delete_id" value="${position.pos_id}">
            ...
            <td>
                <form action="updatePosition" method="post">
                    <input type="hidden" name="update_id" value="${position.pos_id}">
